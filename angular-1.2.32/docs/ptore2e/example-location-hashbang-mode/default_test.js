describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("examples/example-location-hashbang-mode/index1.html");
  });
  
  var addressBar = element(by.css("#addressBar")),
       url = 'http://www.example.com/base/index1.html#!/path?a=b#h';
  ...
  it("should change $location accordingly", function(){
    ...
    expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index1.html#!/first?a=b");
    ...
    expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index1.html#!/sec/ond?flag#hash");
